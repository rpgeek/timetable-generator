...
def add_cls_for_grp(sheet, rw_start, cl_start, grps_lst, start_hour, stop_hour, data):
    """
...
def add_classes(work_sheet, day, start_date,
    ...
    if repeated:
        for _ in range(repeat_factor):
            ...
            col_start = column
            row_start += 4
            add_cls_for_grp(work_sheet, row_start, col_start,
        ...
        col_start = column
        row_start += 4
        add_cls_for_grp(work_sheet, row_start, col_start, grp_lst, start_hour, stop_hour, text)
